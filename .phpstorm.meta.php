...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/acelanz/Desktop/hospital_app/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/acelanz/Desktop/hospital_app/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'login','logout','users.index',
'users.create','users.store','users.edit','users.update','users.destroy','dashboard','profile.edit','profile.update','categories.index',
'categories.create','categories.store','categories.edit','categories.update','categories.destroy',
'suppliers.index','suppliers.create','suppliers.store','suppliers.edit','suppliers.update',
'suppliers.destroy','items.index','items.create','items.store','items.show',
'items.edit','items.update','items.destroy','staff.index','staff.create',
'staff.store','staff.edit','staff.update','staff.destroy','usage.create',
'usage.store','logs.index','stock.create','stock.store','transfers.index',
'transfers.create','transfers.store','borrows.index','borrows.create','borrows.store',
'returns.index','returns.edit','returns.update','disposals.create','disposals.store',
'storage.local',);
        registerArgumentsSet('views', 
'auth.login','borrows.create','borrows.index','categories.create','categories.edit',
'categories.index','dashboard','disposals.create','items.create','items.edit',
'items.index','items.show','layouts.app','logs.index','profile.edit',
'returns.edit','returns.index','staff.create','staff.edit','staff.index',
'stock.create','suppliers.create','suppliers.edit','suppliers.index','transfers.create',
'transfers.index','usage.create','users.create','users.edit','users.index',
