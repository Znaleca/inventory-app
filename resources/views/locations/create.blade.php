...
@section('content')
    <div class="mx-auto max-w-xl">
        ...
        {{-- Page Header --}}
        <div class="mb-5">
            <p class="text-[10px] font-mono font-semibold text-blue-600 uppercase tracking-[0.25em] mb-1">Locations://Create</p>
            <h1 class="text-xl font-bold text-slate-800 tracking-tight">New Tracking Location</h1>
            <p class="text-xs text-slate-400 font-mono mt-0.5">Define where inventory items can be physically stored.</p>
        </div>
