...
<div class="bg-white rounded-2xl overflow-hidden border border-sky-100">
    ...
    <div class="p-6 border-b border-sky-100 flex items-center justify-between shrink-0 mb-6">
        <div>
            <p class="font-mono text-[10px] font-bold uppercase tracking-widest text-sky-500 mb-1">Returns://Process</p>
            <h3 class="text-xl font-black text-[#0f172a] tracking-tight">Process Return</h3>
            <p class="text-xs text-slate-400 font-mono mt-1">Record items being returned to stock or marked as consumed.</p>
        </div>
    </div>
            ...
            <div class="bg-white border border-sky-100 relative overflow-hidden">
                ...
                <div class="px-5 py-4">
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                        <div class="bg-slate-50 border border-sky-100 px-4 py-3">
                            <p class="text-[10px] font-mono font-bold uppercase tracking-widest text-slate-400 mb-1">Item</p>
                            <p class="text-sm font-bold text-[#0f172a] line-clamp-1">{{ $borrow->item->name }}</p>
                        ...
                        <div class="bg-slate-50 border border-sky-100 px-4 py-3">
                            ...
                            <p class="text-sm font-bold text-[#0f172a]">{{ $borrow->borrower_name ?? $borrow->staff?->display_name ?? 'Unknown' }}</p>
                ...
                <div class="ml-1">
                    ...
                    <div class="divide-y divide-slate-100">
                        ...
                        <div class="transition-colors"
                            ...
                            {{-- Checkbox row --}}
                            <label class="flex items-center gap-4 px-5 py-3 cursor-pointer hover:bg-sky-50 transition-colors"
                            ...
                            <div x-show="selected['{{ $entryId }}']" class="px-5 pb-3 pl-[52px]">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <label class="flex items-center gap-1.5 cursor-pointer border px-3 py-2 text-[10px] font-mono font-bold uppercase tracking-widest transition-colors"
                                        :class="dispositions['{{ $entryId }}'] === 'returned_new' ? 'bg-emerald-600 border-emerald-600 text-white' : 'bg-white border-sky-100 text-slate-600 hover:border-emerald-400 hover:text-emerald-700'">
                                    ...
                                    <label class="flex items-center gap-1.5 cursor-pointer border px-3 py-2 text-[10px] font-mono font-bold uppercase tracking-widest transition-colors"
                                        :class="dispositions['{{ $entryId }}'] === 'returned_used' ? 'bg-amber-500 border-amber-500 text-white' : 'bg-white border-sky-100 text-slate-600 hover:border-amber-400 hover:text-amber-700'">
            ...
            <div class="bg-white border border-sky-100 relative"
                ...
                <div class="px-5 py-4">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="number" name="quantity_using" min="0" :max="pending"
                                ...
                                class="block w-full border border-rose-200 bg-rose-50/30 focus:bg-white focus:border-rose-500 focus:outline-none py-2.5 px-3 text-sm font-mono text-[#0f172a] transition-colors">
                    ...
                    <div class="mt-5 border px-4 py-3 flex items-center justify-between transition-all"
                        :class="overMax ? 'bg-rose-50 border-rose-200' : 'bg-slate-50 border-sky-100'">
                        <div class="flex items-center gap-3 font-mono text-sm">
                            <span :class="overMax ? 'text-rose-600 font-bold' : 'text-slate-600'">Total:</span>
                            <span class="font-black text-lg" :class="overMax ? 'text-rose-600' : 'text-[#0f172a]'" x-text="total"></span>
