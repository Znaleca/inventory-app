...
<div class="bg-white rounded-2xl overflow-hidden border border-sky-100">
    ...
    <div class="p-6 border-b border-sky-100 flex items-center justify-between shrink-0 mb-6">
        <div>
            <p class="font-mono text-[10px] font-bold uppercase tracking-widest text-sky-500 mb-1">Admin://Borrows//Edit</p>
            <h3 class="text-xl font-black text-[#0f172a] tracking-tight">Edit Borrow Record</h3>
        </div>
    </div>
    ...
    <div class="p-6 pt-0">
        ...
        <h1 class="text-xl font-bold text-[#0f172a] tracking-tight">Edit Borrow Record</h1>
                ...
                <form action="{{ route('admin.borrows.update', $borrow) }}" method="POST" id="borrow-edit-form">
                    ...
                    <div class="mt-4 pt-4 border-t border-slate-100">
                        ...
                        <input type="text" name="serial_number" id="serial_number" form="borrow-edit-form" value="{{ old('serial_number', $borrow->serial_number === 'N/A' ? '' : $borrow->serial_number) }}"
                            class="block w-full border border-sky-100 bg-slate-50 focus:bg-white focus:border-sky-500 focus:outline-none py-2.5 px-3 text-sm font-mono text-[#0f172a] transition-colors" placeholder="Leave blank for N/A">
                        @endif
            ...
            <div class="px-5 py-5 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div>
                    ...
                    <select name="status" id="status" form="borrow-edit-form"
                        class="block w-full border border-sky-100 bg-slate-50 focus:bg-white focus:border-teal-500 focus:outline-none py-2.5 px-3 text-sm text-[#0f172a] transition-colors">
                ...
                <div>
                    ...
                    <input type="date" name="borrowed_at" id="borrowed_at" form="borrow-edit-form" value="{{ old('borrowed_at', $borrow->borrowed_at?->format('Y-m-d')) }}"
                        class="block w-full border border-sky-100 bg-slate-50 focus:bg-white focus:border-teal-500 focus:outline-none py-2.5 px-3 text-sm font-mono text-[#0f172a] transition-colors">
            ...
            <div class="px-5 py-5 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" form="borrow-edit-form" rows="3"
                        class="block w-full border border-sky-100 bg-slate-50 focus:bg-white focus:border-sky-500 focus:outline-none py-2.5 px-3 text-sm text-[#0f172a] transition-colors">{{ old('notes', $borrow->notes) }}</textarea>
