...
<div class="p-6 border-b border-sky-100 bg-white flex items-center justify-between shrink-0">
    <div>
        <p class="font-mono text-[10px] font-bold uppercase tracking-widest text-sky-500 mb-1">Inventory://Units</p>
        <h3 class="text-xl font-black text-[#0f172a] tracking-tight">Unit Master List</h3>
    </div>
    <span class="rounded-lg bg-sky-50 px-3 py-1.5 text-[11px] font-bold text-sky-600">{{ $units->count() }} units</span>
</div>
...
<div class="bg-white relative overflow-hidden">
            ...
            <tbody class="divide-y divide-sky-50">
                ...
                <tr class="hover:bg-sky-50 transition-colors">
                    <td class="pl-5 pr-3 py-3">
                        <span class="text-base font-black font-mono text-[#0f172a] tracking-tight">{{ $unit->name }}</span>
                    </td>
                    ...
                    <td class="whitespace-nowrap px-3 pr-5 py-3 text-right">
                        <div class="flex items-center justify-end gap-1.5">
                            ...
                            @else
                                <button disabled
                                    class="cursor-not-allowed opacity-40 inline-flex items-center border border-sky-100 bg-sky-50 px-2.5 py-1.5 text-[10px] font-mono font-bold text-slate-400"
    ...
    <div class="flex flex-col items-center justify-center py-20 text-center ml-1">
        ...
        <p class="text-sm font-semibold text-sky-500 mt-1">No units defined yet.</p>
        <a href="{{ route('units.create') }}"
