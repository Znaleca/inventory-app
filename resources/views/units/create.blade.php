...
@section('content')
    <div class="bg-white rounded-2xl overflow-hidden border border-sky-100">
        ...
        <div class="p-6 border-b border-sky-100 bg-white flex items-center justify-between shrink-0 mb-6">
            <div>
                <p class="font-mono text-[10px] font-bold uppercase tracking-widest text-sky-500 mb-1">Units://Create</p>
                <h3 class="text-xl font-black text-[#0f172a] tracking-tight">New Measurement Unit</h3>
                <p class="text-xs text-slate-400 font-mono mt-1">Define a tracking unit to assign to inventory items.</p>
            </div>
        </div>
