...
@section('content')
    <div>
        ...
        {{-- Page Header --}}
        <div class="mb-5">
            <p class="text-[10px] font-mono font-semibold text-violet-600 uppercase tracking-[0.25em] mb-1">Staff://Edit</p>
            <h1 class="text-xl font-bold text-slate-800 tracking-tight">Edit Staff Member</h1>
            <p class="text-xs text-slate-400 font-mono mt-0.5">Update details for {{ $staff->display_name ?? $staff->name }}.</p>
        </div>
