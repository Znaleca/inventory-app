...
<div class="mx-auto max-w-5xl">
    ...
    {{-- Page Header --}}
    <div class="mb-5">
        <p class="text-[10px] font-mono font-semibold text-slate-600 uppercase tracking-[0.25em] mb-1">Users://{{ $user->id }}//Activity</p>
            ...
            <div class="px-6 py-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        <span class="h-2 w-2 bg-slate-500 inline-block"></span>
                        <p class="text-[10px] font-mono font-bold text-slate-500 uppercase tracking-widest">// Activity Log</p>
                    </div>
                    <h2 class="text-base font-bold text-slate-800 tracking-tight">All recorded actions for this account</h2>
                </div>
